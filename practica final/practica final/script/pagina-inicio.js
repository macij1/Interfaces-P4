...
const color_fondo1="#ca787333";
const color_fondo2="#EEB8B5";
const color_fondo3="#ca7873cc";
const color_fondo1_alt="#ff0000";
const color_fondo2_alt="#FFFFFF";
const color_fondo3_alt="#000000e6";

  function ocultarFooter() {
    document.querySelector(".footer").style.display = "none";
    document.querySelector(".cookies-button").style.opacity =  1;
  }
  ...
  function changeTheme(){
    ...
    if(tema == "default"){
      ...
      document.documentElement.style.setProperty("--color-fondo1", color_fondo1_alt);
      document.documentElement.style.setProperty("--color-fondo2", color_fondo2_alt);
      document.documentElement.style.setProperty("--color-fondo3", color_fondo3_alt);
    }else{
      localStorage.setItem('tema', "default");
      document.documentElement.style.setProperty("--color-fondo1", color_fondo1);
      document.documentElement.style.setProperty("--color-fondo2", color_fondo2);
      document.documentElement.style.setProperty("--color-fondo3", color_fondo3);
    }
